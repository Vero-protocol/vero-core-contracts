...
representing this project include using an official project email address,
...
reported by opening an issue in this repository. Reports should include enough
context for maintainers to understand the concern while avoiding unnecessary
personal or sensitive information.

All reports will be reviewed and investigated promptly and fairly. Maintainers
are expected to respect the privacy and security of reporters and affected
community members.
...
Consequence: A private or public written warning from maintainers, providing
...
with the community for a specified period of time. Violating these terms may lead
to a permanent ban.
